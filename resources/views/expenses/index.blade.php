...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-money-bill-wave me-2" style="color: #d4af37;"></i> รายจ่ายทั้งหมด</h2>
        <a href="{{ route('expenses.create') }}" class="btn btn-add-new">
            <i class="fas fa-plus-circle me-1"></i> เพิ่มรายจ่ายใหม่
        </a>
    </div>

    <!-- 🔹 ฟอร์มค้นหา -->
    <div class="card card-dark-red mb-4">
    ...
    <div class="card card-dark-red">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-list me-2"></i> รายการรายจ่าย</h5>
                <span class="badge bg-danger text-white">{{ $expenses->total() }} รายการ</span>
            </div>
        </div>
        <div class="card-body">
            @if($expenses->count() > 0)
            <div class="table-responsive">
                <table class="table  table-dark-red">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge-category">{{ $expense->category }}</span></td>
                            <td class="text-end">{{ number_format($expense->amount, 2) }}</td>
                            <td class="text-center">
                                <a href="{{ route('expenses.edit', $expense->id) }}" class="btn btn-sm btn-warning me-1">
            ...
            <div class="alert alert-warning text-center">
                <i class="fas fa-info-circle me-2"></i> ไม่พบข้อมูลรายจ่ายตามเงื่อนไขที่กำหนด
            </div>
            @endif
        </div>
    </div>
