        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>เพิ่มรายรับใหม่</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('incomes.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                ...
                                <option value="เงินเดือน" {{ old('category') == 'เงินเดือน' ? 'selected' : '' }}>เงินเดือน</option>
                                <option value="โบนัส" {{ old('category') == 'โบนัส' ? 'selected' : '' }}>โบนัส</option>
                                <option value="ค่าคอมมิชชั่น" {{ old('category') == 'ค่าคอมมิชชั่น' ? 'selected' : '' }}>ค่าคอมมิชชั่น</option>
                                <option value="รายได้เสริม" {{ old('category') == 'รายได้เสริม' ? 'selected' : '' }}>รายได้เสริม</option>
                                <option value="เงินกู้" {{ old('category') == 'เงินกู้' ? 'selected' : '' }}>เงินกู้</option>
                                <option value="ของขวัญ" {{ old('category') == 'ของขวัญ' ? 'selected' : '' }}>ของขวัญ</option>
